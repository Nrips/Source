...
{	
	...
	self.fillColor = appUIGreenColor;
    self.strokeColor = appUIGreenColor;
	//self.strokeColor = [UIColor whiteColor];
	self.strokeWidth = 1.0;
    self.textColor = [UIColor whiteColor];
    self.textAttributes = @{NSFontAttributeName:self.font, NSForegroundColorAttributeName:[UIColor purpleColor]};
...
- (void)drawRect:(CGRect)rect 
{
    ...
    CGSize numberSize = [numberString sizeWithAttributes:self.textAttributes];
    //
    ...
    //For ios 7 and above
    [numberString drawAtPoint:textPt withAttributes:self.textAttributes];
    //
